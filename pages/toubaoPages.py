...
class loginPage(PageObject):
    ...
    def login(self,usrname,passwd):
        ...
        self.che_toubao()
        print "che_toubao click ok"
        #toubaoPage(self.browser).wait_for_page()

class toubaoPage(PageObject):
    url = 'https://cx.chinahuanong.com.cn/#/dashboard'
    #首页是否加载完成
    def is_browser_on_page(self):
        return self.q(xpath='//*[@id="push-menu-container"]/div[2]/div/div[1]/nav/ul/li[1]/a/div[2]/span').is_present()
    ...
    #@property
    def toubao(self,maintenanceStaff,plateNo,vIN,engine,years,registerDate,ID):
        self.keche()
