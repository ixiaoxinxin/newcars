...
from pages.GitHubSearchPage import GitHubSearchPage,GitHubSearchResultsPage
class TestGitHub(WebAppTest):
    ...
    def setUp(self):
        ...
        self.github__results__page = GitHubSearchResultsPage(self.browser)
    ...
    def test_search(self):
        ...
        search_results = self.github__results__page.search_results
