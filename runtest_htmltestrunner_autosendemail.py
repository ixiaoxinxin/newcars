...
def send_email(newfile):
    ...
    # 发送邮箱服务器
    smtpserver = 'mail.chinahuanong.com.cn'
    # 发送邮箱用户名/密码
    user = 'zhangkexin@chinahuanong.com.cn'
    password = 'zkx900510'
    # 发送邮箱
    sender = 'zhangkexin@chinahuanong.com.cn'
    # 多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver = ['zhangkexin@chinahuanong.com.cn']
    # 发送邮件主题
    subject = '自动定时发送测试报告'
    ...
    msg_html["Content-Disposition"] = 'attachment; filename="TestReportForNewCars.html"'
    msg.attach(msg_html)
    ...
    msg['From'] = 'zhangkexin@chinahuanong.com.cn'
...
if __name__ == '__main__':
    ...
    test_dir = 'C:\\Users\\lenovo\\Desktop\\newcars\\testcases'
    # 知道测试报告的路径
    test_report_dir = 'C:\\Users\\lenovo\\Desktop\\testresult'
